...
def random_coin(F1_t, F1_tMinusOne, F1min_t, F1min_tMinusOne):
    if ((1 - F1_t) <= (1-F1_tMinusOne)) and ((1-F1min_t) <= (1 - F1min_tMinusOne)):
        #print("accepted training F1_t:",F1_t)
        #print("accepted training F1min_t:",F1min_t)
        #print("training F1_tMinusOne:",F1_tMinusOne)
        #print("training F1min_tMinusOne:",F1min_tMinusOne)
        return True
    else:
        #print("rejected training F1_t:",F1_t)
        #print("rejected training F1min_t:",F1min_t)
        return False
...
def BALBO(Majority_data_training, Minority_data_training, No_of_steps, X_state_test, y_label_test, X_state_valid, y_label_valid, n_points=16):
    ...
    print("burnIn initial_MAJ length:", len(initial_MAJ))
